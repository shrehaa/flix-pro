...
const Search = () => {
  ...
  const handleGPTSearch = async () => {
    ...
    const gptQuery =
      ...
      " . Only give me names of 12 movies, comma seperated like the example result given ahead. Example result : Don, Mai Khiladi Tu Anadi, Golmaal, Hera Pheri, Chup Chup Ke";
